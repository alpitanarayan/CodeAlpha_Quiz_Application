...
questions = ["1. How is an array initialized in C language ?",
            ...
            "7. Which function is used to open a file in C++ ?",
            "8. Which function is used to close a file in C++ ?",
            "9. Which datastructure is used to handle recursion in C ?",
            "10. Who develop the C language ?"
             ]
options = [['int a[2] = {1,2,3};', 'int a = {1,2,3};', 'int a[] = {1,2,3}', 'none','int a = {1,2,3};'],
            ['31','32','23','30','32'],
            ['while loop', 'do-while loop', 'for loop', 'All of the above','do-while loop'],
            ['4','2','8','1','4'],
            ['int*var', 'int**var', 'int&var', 'None','int**var'],
            ['C','C++','Python','Java','C'],
            ['fopen','fclose','fseek','fwrite','fopen'],
            ['fopen','fclose','fseek','fwrite','fclose'],
            ['stack','queue','dequeue','None of the above','stack'],
            ['Dennis MacAlistair Ritchie', 'Guido van Rossum', 'James Gosling', 'None','Dennis MacAlistair Ritchie']]
